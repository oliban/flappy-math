...
const translations = {
  en: {
    ...
    locationTitle: 'Weather location',
    locationHint: 'Search for a place, or use where you are',
    locationSearch: 'Search',
    locationPlaceholder: 'Town or city',
    locationUseMine: 'Use my location',
    locationUseDefault: 'Use Mölndal',
    locationSearching: 'Searching...',
    locationNoResults: 'No places found',
    locationFailed: 'Could not look that up',
    ...
    pressToContinue: 'SPACE to play again',
  ...
  sv: {
    ...
    // Weather
    weatherClear: 'Klart',
    weatherMostlyClear: 'Mest klart',
    weatherPartlyCloudy: 'Halvklart',
    weatherOvercast: 'Mulet',
    weatherFog: 'Dimma',
    weatherDrizzle: 'Duggregn',
    weatherRain: 'Regn',
    weatherSnow: 'Snö',
    weatherShowers: 'Skurar',
    weatherSnowShowers: 'Snöbyar',
    weatherThunder: 'Åska',
    weatherUnknown: 'Väder',
    weatherUnavailable: 'Väder otillgängligt',
    locationTitle: 'Väderplats',
    locationHint: 'Sök efter en plats, eller använd din egen',
    locationSearch: 'Sök',
    locationPlaceholder: 'Stad eller ort',
    locationUseMine: 'Använd min plats',
    locationUseDefault: 'Använd Mölndal',
    locationSearching: 'Söker...',
    locationNoResults: 'Inga platser hittades',
    locationFailed: 'Kunde inte söka',
    ...
    pressToContinue: 'MELLANSLAG för att spela igen',
